import { PaymentRequirements, PaymentRequired, VerifyResponse, SettleResponse, SupportedResponse } from '@payai/x402/types';
export { PaymentRequired, PaymentRequirements, SettleResponse, VerifyResponse } from '@payai/x402/types';
import { e as X402ServerConfig, R as RouteConfig } from '../solana-payment-6F7H5TeY.js';
export { T as TokenAsset } from '../solana-payment-6F7H5TeY.js';
...
declare class X402PaymentHandler {
     ...
     */
    createPaymentRequirements(routeConfig: RouteConfig, resourceUrl: string): Promise<PaymentRequirements>;
    /**
     ...
     * @param resourceUrl - URL of the protected resource
     */
    create402Response(requirements: PaymentRequirements, resourceUrl: string): {
        status: 402;
...
export { FacilitatorClient, RouteConfig, X402PaymentHandler, X402ServerConfig };
