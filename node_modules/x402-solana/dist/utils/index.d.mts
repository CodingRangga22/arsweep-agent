...
import { T as TokenAsset } from '../solana-payment-6F7H5TeY.mjs';
 ...
 */
declare function createPaymentPayload(transaction: VersionedTransaction, paymentRequirements: PaymentRequirements, resourceUrl: string): string;
/**
 ...
 */
declare function createPaymentPayloadV1(transaction: VersionedTransaction, paymentRequirements: PaymentRequirements): string;
/**
 ...
 */
declare function getRpcUrlForNetwork(network: string): string;
/**
 * Get default USDC token asset for a given Solana network
 * @param network - Network in any format (simple or CAIP-2)
 * @returns USDC token asset configuration
 */
declare function getDefaultTokenAsset(network: string): TokenAsset;
/**
...
export { createPaymentPayload, createPaymentPayloadV1, fromAtomicUnits, getDefaultRpcUrl, getDefaultTokenAsset, getRpcUrlForNetwork, toAtomicUnits };
